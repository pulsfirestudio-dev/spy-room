...
const getStyles = (colors, isDarkMode) => {
  return StyleSheet.create({
    ...
    backBtn: { fontSize: 14, fontFamily: 'Special_Elite_400Regular', color: '#FFFFFF' },
    headerTitle: { fontSize: 16, fontFamily: 'Special_Elite_400Regular', color: '#FFFFFF' },
    content: { flex: 1 },
    scrollContent: { paddingBottom: 30 },
    titleSection: { paddingHorizontal: 16, paddingVertical: 24, alignItems: 'center' },
    title: { fontSize: 25, fontFamily: 'Special_Elite_400Regular', marginBottom: 6, textAlign: 'center', letterSpacing: -0.5 },
    subtitle: { fontSize: 13, textAlign: 'center', fontFamily: 'Special_Elite_400Regular' },
    ...
    smallCategoryName: { fontSize: 14, fontFamily: 'Special_Elite_400Regular', color: '#FFFFFF' },
    voteBarBg: {
    ...
    voteCount: { fontSize: 12, color: 'rgba(255,255,255,0.7)', fontFamily: 'Special_Elite_400Regular' },
    smallVoteBtn: {
      paddingVertical: 10, paddingHorizontal: 18,
      borderRadius: 10, marginLeft: 12,
    },
    voteBtnText: { color: '#FFFFFF', fontSize: 13, fontFamily: 'Special_Elite_400Regular', textAlign: 'center' },
    // Modal
    promptOverlay: {
    ...
    selectedName: { fontSize: 18, fontFamily: 'Special_Elite_400Regular', letterSpacing: -0.5, marginBottom: 4 },
    selectedVoteCount: { fontSize: 13, fontFamily: 'Special_Elite_400Regular' },
    promptTitle: { fontSize: 21, fontFamily: 'Special_Elite_400Regular', marginBottom: 12, textAlign: 'center' },
    promptMessage: { fontSize: 13, textAlign: 'center', lineHeight: 20, marginBottom: 24, fontFamily: 'Special_Elite_400Regular' },
    purchaseBtnGradient: {
    ...
    purchaseBtnText: { fontSize: 14, fontFamily: 'Special_Elite_400Regular', color: '#FFFFFF', letterSpacing: 0.5 },
    skipBtn: { width: '100%', paddingVertical: 12, alignItems: 'center', borderRadius: 10, borderWidth: 2 },
    skipBtnText: { fontSize: 13, fontFamily: 'Special_Elite_400Regular' },
  });
};
