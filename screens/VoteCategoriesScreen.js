...
const getStyles = (colors, isDarkMode) => {
  return StyleSheet.create({
    ...
    backBtn: { fontSize: 16, fontFamily: 'Orbitron_700Bold', color: '#FFFFFF' },
    headerTitle: { fontSize: 18, fontFamily: 'Orbitron_700Bold', color: '#FFFFFF' },
    content: { flex: 1 },
    scrollContent: { paddingBottom: 30 },
    titleSection: { paddingHorizontal: 16, paddingVertical: 24, alignItems: 'center' },
    title: { fontSize: 28, fontFamily: 'Orbitron_900Black', marginBottom: 6, textAlign: 'center', letterSpacing: -0.5 },
    subtitle: { fontSize: 14, textAlign: 'center', fontFamily: 'Orbitron_700Bold' },
    ...
    smallCategoryName: { fontSize: 16, fontFamily: 'Orbitron_700Bold', color: '#FFFFFF' },
    voteBarBg: {
    ...
    voteCount: { fontSize: 12, color: 'rgba(255,255,255,0.7)', fontFamily: 'Orbitron_700Bold' },
    smallVoteBtn: {
      paddingVertical: 10, paddingHorizontal: 18,
      borderRadius: 10, marginLeft: 12,
    },
    voteBtnText: { color: '#FFFFFF', fontSize: 14, fontFamily: 'Orbitron_700Bold', textAlign: 'center' },
    // Modal
    promptOverlay: {
    ...
    selectedName: { fontSize: 20, fontFamily: 'Orbitron_700Bold', letterSpacing: -0.5, marginBottom: 4 },
    selectedVoteCount: { fontSize: 15, fontFamily: 'Orbitron_700Bold' },
    promptTitle: { fontSize: 24, fontFamily: 'Orbitron_900Black', marginBottom: 12, textAlign: 'center' },
    promptMessage: { fontSize: 13, textAlign: 'center', lineHeight: 20, marginBottom: 24, fontFamily: 'Orbitron_400Regular' },
    purchaseBtnGradient: {
    ...
    purchaseBtnText: { fontSize: 16, fontFamily: 'Orbitron_700Bold', color: '#FFFFFF', letterSpacing: 0.5 },
    skipBtn: { width: '100%', paddingVertical: 12, alignItems: 'center', borderRadius: 10, borderWidth: 2 },
    skipBtnText: { fontSize: 14, fontFamily: 'Orbitron_700Bold' },
  });
};
