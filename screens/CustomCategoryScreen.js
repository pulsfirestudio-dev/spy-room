...
const getStyles = (colors, isDarkMode) => StyleSheet.create({
  ...
  title: { fontSize: 22, fontFamily: 'Orbitron_900Black', color: '#fff', letterSpacing: 1, textShadowColor: isDarkMode ? colors.primary : 'transparent', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: isDarkMode ? 2 : 0 },
  placeholder: { width: 44 },
  inputGroup: { marginBottom: 25 },
  label: { fontSize: 14, fontFamily: 'Orbitron_700Bold', color: '#fff', letterSpacing: 2, marginBottom: 10 },
  ...
  addButtonText: { color: '#fff', fontFamily: 'Orbitron_700Bold' },
  ...
  wordNumber: { color: '#fff', fontFamily: 'Orbitron_700Bold', width: 30 },
  wordText: { flex: 1, color: '#fff', fontSize: 16, fontFamily: 'Orbitron_700Bold' },
  ...
  progressText: { color: '#fff', fontFamily: 'Orbitron_700Bold' },
  ...
  saveButtonText: { color: '#fff', fontSize: 18, fontFamily: 'Orbitron_700Bold', letterSpacing: 2 },
  ...
  backButtonText: { color: '#fff', fontSize: 16, fontFamily: 'Orbitron_700Bold' },
});
