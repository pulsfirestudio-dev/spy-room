...
const getStyles = (colors, isDarkMode) => StyleSheet.create({
  ...
  title: { fontSize: 20, fontFamily: 'Special_Elite_400Regular', color: '#fff', letterSpacing: 1, textShadowColor: isDarkMode ? colors.primary : 'transparent', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: isDarkMode ? 2 : 0 },
  placeholder: { width: 44 },
  inputGroup: { marginBottom: 25 },
  label: { fontSize: 13, fontFamily: 'Special_Elite_400Regular', color: '#fff', letterSpacing: 2, marginBottom: 10 },
  ...
  addButtonText: { color: '#fff', fontFamily: 'Special_Elite_400Regular' },
  ...
  wordNumber: { color: '#fff', fontFamily: 'Special_Elite_400Regular', width: 30 },
  wordText: { flex: 1, color: '#fff', fontSize: 14, fontFamily: 'Special_Elite_400Regular' },
  ...
  progressText: { color: '#fff', fontFamily: 'Special_Elite_400Regular' },
  ...
  saveButtonText: { color: '#fff', fontSize: 16, fontFamily: 'Special_Elite_400Regular', letterSpacing: 2 },
  ...
  backButtonText: { color: '#fff', fontSize: 14, fontFamily: 'Special_Elite_400Regular' },
});
