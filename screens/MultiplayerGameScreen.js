...
const getStyles = (colors, isDarkMode) => StyleSheet.create({
  ...
  phaseLabel: { fontSize: 16, fontWeight: '900', letterSpacing: 3, color: isDarkMode ? '#fff' : '#000' },
  phaseDesc: { fontSize: 13, color: isDarkMode ? '#aaa' : colors.text, textAlign: 'center', marginBottom: 18 },
  progressText: {
  ...
  roleDesc: { fontSize: 13, color: isDarkMode ? '#aaa' : colors.text, textAlign: 'center', lineHeight: 22 },
  wordCard: {
  ...
  wordText: { fontSize: 29, fontWeight: '900', color: isDarkMode ? '#fff' : '#000', letterSpacing: 2 },
  hintText: { fontSize: 13, color: isDarkMode ? '#aaa' : colors.text, fontStyle: 'italic' },
  waitingBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    justifyContent: 'center', paddingVertical: 14,
  },
  waitingBadgeText: { color: isDarkMode ? '#aaa' : colors.text, fontSize: 13, fontStyle: 'italic' },
  primaryBtn: {
  ...
  primaryBtnText: { color: isDarkMode ? '#000' : '#fff', fontSize: 14, fontWeight: '900', letterSpacing: 2 },
  ...
  clueInput: {
    ...
    fontSize: 18, color: isDarkMode ? '#fff' : '#000', fontWeight: '700',
  },
  submittedBadge: {
  ...
  submittedText: { color: isDarkMode ? '#fff' : '#000', fontSize: 14, fontWeight: '700', flex: 1 },
  listCard: {
  ...
  listRowLeft: { fontSize: 13, color: isDarkMode ? '#aaa' : colors.text, fontWeight: '600' },
  listRowRight: { fontSize: 13, fontWeight: '800', color: isDarkMode ? '#fff' : '#000' },
  videoBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10,
    backgroundColor: '#0066ff', paddingVertical: 16, borderRadius: 14,
    marginBottom: 14, borderWidth: 2, borderColor: '#0044cc',
  },
  videoBtnText: { color: '#fff', fontSize: 13, fontWeight: '800', letterSpacing: 1 },
  hostBtn: {
    backgroundColor: 'transparent', paddingVertical: 14, borderRadius: 14,
    borderWidth: 2, borderColor: colors.primary, alignItems: 'center',
    marginTop: 10, gap: 4,
  },
  hostBtnText: { color: colors.primary, fontSize: 13, fontWeight: '800', letterSpacing: 1 },
  ...
  voteName: { flex: 1, fontSize: 15, fontWeight: '700', color: isDarkMode ? '#fff' : '#000' },
  votePill: {
  ...
  outcome: { fontSize: 27, fontWeight: '900', textAlign: 'center', marginBottom: 24, letterSpacing: 1 },
  spyCard: {
    backgroundColor: colors.surface, borderRadius: 14, padding: 18,
    borderWidth: 3, borderColor: '#ff1a1a', marginBottom: 12,
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
  },
  spyName: { fontSize: 20, fontWeight: '900', color: '#ff1a1a' },
