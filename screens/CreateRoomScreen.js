...
const getStyles = (colors, isDarkMode) => {
  ...
  return StyleSheet.create({
    ...
    title: { fontSize: 23, fontFamily: 'SpecialElite_400Regular', color: isDarkMode ? '#fff' : '#000', letterSpacing: 3 },
    placeholder: { width: 44 },
    section: { marginBottom: 28 },
    sectionTitle: { fontSize: 14, fontFamily: 'SpecialElite_400Regular', color: isDarkMode ? '#ffffff' : '#000000', marginBottom: 14, letterSpacing: 3 },
    ...
    helperText: { marginTop: 10, color: isDarkMode ? '#aaaaaa' : colors.text, fontFamily: 'SpecialElite_400Regular', fontSize: 13 },
    helperTextOk: { marginTop: 10, color: isDarkMode ? '#9dffb3' : '#0a6b2d', fontFamily: 'SpecialElite_400Regular', fontSize: 13 },
    ...
    counterText: { color: isDarkMode ? '#ffffff' : '#000000', fontSize: 21, fontFamily: 'SpecialElite_400Regular' },
    ...
    toggleSquareTitle: { color: isDarkMode ? '#ffffff' : '#000000', fontFamily: 'SpecialElite_400Regular', fontSize: 13, letterSpacing: 1, textAlign: 'center' },
    ...
    toggleIndicatorText: { color: isDarkMode ? '#888888' : colors.text, fontFamily: 'SpecialElite_400Regular', fontSize: 12 },
