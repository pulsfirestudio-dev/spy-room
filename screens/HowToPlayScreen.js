...
const getStyles = (colors, isDarkMode) => StyleSheet.create({
  ...
  title: { fontSize: 22, fontFamily: 'Orbitron_900Black', color: isDarkMode ? '#fff' : '#000', letterSpacing: 1, textShadowColor: isDarkMode ? colors.primary : 'transparent', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: isDarkMode ? 2 : 0 },
  ...
  stepTitle: { fontSize: 16, fontFamily: 'Orbitron_700Bold', color: isDarkMode ? '#fff' : '#000', marginBottom: 8, letterSpacing: 0.5 },
  stepText: { fontSize: 14, fontFamily: 'Orbitron_400Regular', color: isDarkMode ? '#fff' : '#000', lineHeight: 22 },
  ...
  tipsTitle: { fontSize: 16, fontFamily: 'Orbitron_700Bold', color: isDarkMode ? '#fff' : '#000', marginBottom: 15, letterSpacing: 0.5 },
  tipText: { fontSize: 13, fontFamily: 'Orbitron_400Regular', color: isDarkMode ? '#fff' : '#000', marginBottom: 8, lineHeight: 22 },
