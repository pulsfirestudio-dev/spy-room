...
const getStyles = (colors, isDarkMode) => StyleSheet.create({
  ...
  title: { fontSize: 20, fontFamily: 'SpecialElite_400Regular', color: isDarkMode ? '#fff' : '#000', letterSpacing: 3 },
  subtitle: { textAlign: 'center', color: isDarkMode ? '#aaa' : colors.text, fontSize: 13, marginBottom: 32, fontFamily: 'SpecialElite_400Regular' },
  nameSection: { marginBottom: 28 },
  label: { fontSize: 12, fontFamily: 'SpecialElite_400Regular', letterSpacing: 2, color: isDarkMode ? '#aaa' : colors.text, marginBottom: 8 },
  input: {
    backgroundColor: colors.surface, borderRadius: 14, padding: 16,
    borderWidth: 2, borderColor: isDarkMode ? '#fff' : '#000',
    fontSize: 16, color: isDarkMode ? '#fff' : '#000', fontFamily: 'SpecialElite_400Regular',
  },
  cards: { gap: 14 },
  ...
  cardTitle: { fontSize: 16, fontFamily: 'SpecialElite_400Regular', letterSpacing: 2, color: '#fff' },
  cardDesc: { fontSize: 13, color: 'rgba(255,255,255,0.7)', textAlign: 'center', fontFamily: 'SpecialElite_400Regular' },
});
