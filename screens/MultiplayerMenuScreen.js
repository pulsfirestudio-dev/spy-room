...
const getStyles = (colors, isDarkMode) => StyleSheet.create({
  ...
  title: { fontSize: 22, fontFamily: 'Orbitron_900Black', color: isDarkMode ? '#fff' : '#000', letterSpacing: 3 },
  subtitle: { textAlign: 'center', color: isDarkMode ? '#aaa' : colors.text, fontSize: 14, marginBottom: 32, fontFamily: 'Orbitron_400Regular' },
  nameSection: { marginBottom: 28 },
  label: { fontSize: 12, fontFamily: 'Orbitron_700Bold', letterSpacing: 2, color: isDarkMode ? '#aaa' : colors.text, marginBottom: 8 },
  input: {
    backgroundColor: colors.surface, borderRadius: 14, padding: 16,
    borderWidth: 2, borderColor: isDarkMode ? '#fff' : '#000',
    fontSize: 18, color: isDarkMode ? '#fff' : '#000', fontFamily: 'Orbitron_700Bold',
  },
  cards: { gap: 14 },
  ...
  cardTitle: { fontSize: 18, fontFamily: 'Orbitron_900Black', letterSpacing: 2, color: '#fff' },
  cardDesc: { fontSize: 13, color: 'rgba(255,255,255,0.7)', textAlign: 'center', fontFamily: 'Orbitron_400Regular' },
});
