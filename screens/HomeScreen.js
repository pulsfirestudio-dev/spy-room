...
const getStyles = (colors, isDarkMode) => StyleSheet.create({
  ...
  title: {
    fontSize: 48, fontFamily: 'Orbitron_900Black', color: '#fff', letterSpacing: 6,
  ...
  buttonText: { color: '#fff', fontSize: 18, fontFamily: 'Orbitron_700Bold', letterSpacing: 3 },
  multiplayerBtn: {
  ...
  secondaryButtonText: {
    ...
    fontSize: 14, fontFamily: 'Orbitron_700Bold', letterSpacing: 1,
  ...
  version: {
    ...
    fontSize: 12, letterSpacing: 2, fontFamily: 'Orbitron_400Regular',
  },
});
