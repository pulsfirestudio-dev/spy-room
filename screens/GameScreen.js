...
const getStyles = (colors, isDarkMode) => {
  ...
  return StyleSheet.create({
    ...
    phaseTitle: { fontSize: 16, fontFamily: 'Special_Elite_400Regular', color: colors.text, letterSpacing: 4, marginBottom: 20 },
    playerName: { fontSize: 27, fontFamily: 'Special_Elite_400Regular', color: colors.text, marginBottom: 25 },
    ...
    roleTitle: { fontSize: 13, marginBottom: 10, letterSpacing: 3, fontFamily: 'Special_Elite_400Regular' },
    roleText: { fontSize: 23, fontFamily: 'Special_Elite_400Regular', marginBottom: 12, letterSpacing: 2 },
    ...
    wordLabel: { fontSize: 13, marginBottom: 5, letterSpacing: 2, fontFamily: 'Special_Elite_400Regular' },
    wordText: { fontSize: 27, fontFamily: 'Special_Elite_400Regular', letterSpacing: 2 },
    hintBox: { padding: 14, borderRadius: 12, marginTop: 10, borderWidth: 2, backgroundColor: "rgba(255,255,255,0.3)" },
    hintLabel: { fontFamily: 'Special_Elite_400Regular', fontSize: 13 },
    ...
    revealText: { color: "#fff", fontFamily: 'Special_Elite_400Regular', marginTop: 10, fontSize: 13, letterSpacing: 1, textAlign: "center" },
    ...
    passButtonText: { color: "#fff", fontFamily: 'Special_Elite_400Regular', fontSize: 14, letterSpacing: 1, flex: 1, textAlign: "center" },
    timerContainer: { alignItems: "center", marginBottom: 30 },
    timerText: { fontSize: 80, fontFamily: 'Special_Elite_400Regular', color: colors.text, marginBottom: 20 },
    ...
    timerTextSmall: { fontSize: 25, fontFamily: 'Special_Elite_400Regular', color: colors.text, marginBottom: 10 },
    ...
    cluePlayer: { color: colors.text, fontFamily: 'Special_Elite_400Regular', marginBottom: 5, fontSize: 13 },
    clueText: { color: colors.text, fontSize: 18, fontStyle: "italic" },
    clueLabel: { color: colors.text, marginBottom: 20, fontSize: 14, letterSpacing: 2 },
    ...
    clueButtonText: { color: "#fff", fontFamily: 'Special_Elite_400Regular', fontSize: 14 },
    interrogationText: { color: colors.text, fontSize: 18, fontStyle: "italic" },
    ...
    voteButtonText: { color: colors.text, fontFamily: 'Special_Elite_400Regular', fontSize: 16 },
    ...
    winnerText: { fontSize: 23, fontFamily: 'Special_Elite_400Regular', textAlign: "center", letterSpacing: 3 },
    ...
    revealTitle: { color: colors.text, fontSize: 13, marginBottom: 10, letterSpacing: 2 },
    revealWord: { color: colors.text, fontSize: 36, fontFamily: 'Special_Elite_400Regular', marginBottom: 20 },
    spiesTitle: { color: colors.text, fontSize: 13, marginBottom: 10, letterSpacing: 2 },
    spyName: { color: "#ff1a1a", fontSize: 18, fontFamily: 'Special_Elite_400Regular' },
    ...
    resultButtonText: { color: colors.text, fontFamily: 'Special_Elite_400Regular', fontSize: 14, letterSpacing: 2 },
  });
};